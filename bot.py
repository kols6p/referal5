...
# from referral_system import check_user_premium
...
def check_file_access(user_id):
    """File access check karega"""
    
    # ✅ 1. FIRST CHECK REFERRAL PREMIUM
    if check_user_premium(user_id):
        return True
    
    # ✅ 2. EXISTING TOKEN VERIFICATION (aapka current logic)
    if has_valid_token(user_id):  # Aapka existing token function
        return True
